  ...
  return (
    <div className="accordion-item">
      <div className={`accordion-item__header ${setHeaderActive}`}>
        <button
          type="button"
          className="accordion-item__header__button d-flex flex-row justify-content-between align-items-start w-100 text-left"
      ...
      <div ref={divBodyRef} className="accordion-item__body pt-0 ppb-1 px-1">
        <p>
          {body}
          <br />
        </p>
